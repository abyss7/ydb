...
// GetArrowType() and its CreateEmptyArrowImpl<> helpers live in arrow_type.cpp
// (target :arrow_type) so that low-level consumers can use the type mapping
// without pulling in the whole :arrow library.
