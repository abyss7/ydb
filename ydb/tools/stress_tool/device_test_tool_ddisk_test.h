...
static TSystemEvent DDiskDoneEvent(TSystemEvent::rAuto);
static TSystemEvent DDiskResultsPrintedEvent(TSystemEvent::rAuto);
...
struct TDDiskTest : public TPDiskTest<ChunkSize> {
    ...
    TDDiskTest(const TPerfTestConfig& cfg, const NDevicePerfTest::TDDiskTest& testProto)
